...
var HelloUser = function HelloUser(props) {
  ...
  props.client.iparams.get('contact').then(function (data) {
  ...
  function firstnameChange() {
    return _firstnameChange.apply(this, arguments);
  }
  function _firstnameChange() {
    _firstnameChange = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var response;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return client.request.invoke("getCrmData", props);
          case 3:
...
//# sourceMappingURL=main.9cfbf1ad.js.map